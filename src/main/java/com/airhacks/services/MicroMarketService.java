...
import com.airhacks.entities.MicroMarket;
...
@Stateless
@Path("micro-markets")
public class MicroMarketService extends AbstractFacade<MicroMarket> {

    @PersistenceContext(unitName = "com.asaker_jaxrs-sample_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    public MicroMarketService() {
